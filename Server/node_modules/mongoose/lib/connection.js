...
function _handleConnectionErrors(err) {
  if (err?.name === 'MongoServerSelectionError') {
    console.error("MongoServerSelectionError:", err.message);
    console.error("Detailed Error:", err.reason); // Log detailed error for debugging
    
    // Wrap the original error in a new ServerSelectionError
